                ...
                {this.state.confirm_dialog ? <div className='confirm-top'>
                    <div className='react-confirm-alert'>
                        <div className='confirm-body'>
                            ...
                            <br />
                            <button onClick={this.delete_log} className="pure-button pure-button-primary">Yes</button>
                            <button onClick={this.close_confirm} className="pure-button pure-button-primary button-confirm-no">No</button>
                        </div>
                    </div>
                </div> : null}
                                    ...
                                    <td>
                                        {
                                            this.state.log_clicked === log._id && this.state.deleting_log ?
                                                ...
                                                :
                                                <div onClick={() => this.open_confirm(log._id)} className="delete-log">x</div>
                                        }
                                    </td>
                                </tr>
                            )
